  ...
  return (
    <div>
      <div className={styles.hiring}>
        <img className={styles.compName}  src={img[0][state2]} alt="1"></img>
        <img className={styles.compName}  src={img[1][state]} alt="1"></img>
        <img className={styles.compName}  src={img[2][state2]} alt="1"></img>
        <img className={styles.compName}  src={img[3][state]} alt="1"></img>
        <img className={styles.compName}  src={img[4][state2]} alt="1"></img>
        <img className={styles.compName}  src={img[5][state]} alt="1"></img>
      </div>
      <div style={{ display: "flex" }}>
        <div className={styles.hiring2}>
          <img className={styles.compName2}  src={img2[0][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[1][state]} alt="1"></img>
          <img className={styles.compName2}  src={img2[2][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[3][state]} alt="1"></img>
          <img className={styles.compName2}  src={img2[4][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[5][state]} alt="1"></img>
          <img className={styles.compName}  src={img[4][state2]} alt="1"></img>
          <img className={styles.compName}  src={img[2][state]} alt="1"></img>
          <img className={styles.compName2}  src={img2[6][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[7][state]} alt="1"></img>
          <img className={styles.compName2}  src={img2[8][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[9][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[10][state]} alt="1"></img>
          <img className={styles.compName2}  src={img2[11][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[0][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[1][state]} alt="1"></img>
          <img className={styles.compName2}  src={img2[2][state2]} alt="1"></img>
          <img className={styles.compName2}  src={img2[3][state]} alt="1"></img>
