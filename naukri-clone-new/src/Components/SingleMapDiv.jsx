        ...
        <div className={styled.box} key={id}>
            ...
            <div className={styled.flex}>
                ...
                <div className={styled.flex} style={{ marginLeft: "61%" }}>
                    <div>
                        {isSave ? <img className={styled.img} src="https://img.icons8.com/material-sharp/24/000000/star.png" /> : <img className={styled.img} src="https://img.icons8.com/metro/50/000000/star.png" alt="" />}
                    </div>
