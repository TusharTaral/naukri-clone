...
export const JobDescription = () => {
    ...
    return isLoading1?<div>...loading</div>:(
        <>
            <ProfileNav/>
            ...
            <div className={styles.container}>
                ...
                <SideBarItem label={`0-${data.experience} years`}>
                    <img src="https://img.icons8.com/android/20/000000/suitcase.png" />
                </SideBarItem>
                </div>
                <div className={styles.container3}>
                    <SideBarItem label={`${data.salary} P.A.`}>
                        <img  src="https://img.icons8.com/material-sharp/20/000000/rupee.png" />
                    </SideBarItem>
            ...
            <div style={{marginTop:26}} className={styles.container5}  >
                ...
                <ul style={{marginLeft:30 ,fontSize:14,marginTop:27}}>
            ...
            <p style={{marginLeft:100,marginTop:10}}>Naukri.com does not promise a job or an interview in exchange of money. Fraudsters may ask you to pay in the<br/> pretext of registration fee, Refundable Fee…Read More</p>
